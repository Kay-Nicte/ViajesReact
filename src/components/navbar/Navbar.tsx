    ...
    interface NavbarProps {
        ...
        favorites: Destination[]; // Prop para recibir los favoritos
    }

    const Navbar: React.FC<NavbarProps> = ({ onSearch, addToFavorites, favorites }) => {
        ...
        <ModalDestination
            ...
            selectedDestination={selectedDestination} // Pasa el destino seleccionado aquí
